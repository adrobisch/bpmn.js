...
var bundleFactory = function(sax, $, _, fabric, Q) {/**
...
define('q',[],function () {
  ...
  return (typeof Q !== 'undefined') ? Q : __nodeRequire('q')
}
});
...
if (__isAMD) {
  return define(['sax', 'jquery', 'lodash', 'fabric', 'q'], bundleFactory);
} else {
    if (__isNode) {
        return module.exports = bundleFactory(require('sax'), require('jquery'), require('lodash'), require('fabric'), require('q'));
    } else {
        return bundleFactory((typeof sax !== 'undefined') ? sax : void 0, (typeof $ !== 'undefined') ? $ : void 0, (typeof _ !== 'undefined') ? _ : void 0, (typeof fabric !== 'undefined') ? fabric : void 0, (typeof Q !== 'undefined') ? Q : void 0);
    }
}
